...
//old
$txt['ALLOWLISTFOR'] = "__PARAM__ 의 화이트리스트";
//old
...
$txt['ALLOWLISTTOPICTITLE'] = "화이트리스트";
...
$txt['ALLOWLISTSHORTHELP'] = "화이트리스트에는  검역서에 보관하지 않을 메일주소가 포함되어야 합니다. <br />
경고: 이 기능은 전체적인 보호를 감소시키기 때문에 임시 해결책으로 사용되어야 합니다.
...
";
$txt['ALLOWLISTFORADDRESS'] = "이 주소의 화이트 리스트";
$txt['ADDAALLOWENTRY'] = "목록에 주소 추가";
$txt['ALLOWLISTENTRYTOADD'] = "화이트 리스트에 추가하고 싶은 주소를 입력하십시오. 설명을 추가할 수도 있습니다.";
$txt['REMOVEAALLOWENTRYSHORTHELP'] = "수정하고 싶은 하나이상의 주소를 선택하고, 원하는 버튼을 누르세요.";
 ...
 * Allowlist rule
 */
$txt['ADDALLOWLIST'] = "동일한 발송메일의 스팸메일을 화이트리스트에 추가하시겠습니까?";
/*
 * Newsletter rule
 */
$txt['ADDNEWSLIST'] = "같은 발신메일에서 도착하는 모든 뉴스레터를 수신하시겠습니까?";
$txt['SENDERVARIATIONS'] = "보낸 주소의 모든 변형";
$txt['NOTALLOWLISTBODY'] = "화이트리스트 추가 중 문제가 발생했습니다.";
$txt['NOTALLOWLISTHEAD'] = "화이트리스트 규칙이 추가되지 않았습니다.";
$txt['ALLOWLISTBODY'] = "화이트리스트 규칙이 추가되었습니다. 이 메일로부터 발송된 메일은 더 이상 스팸으로 표시되지 않습니다.";
$txt['ALLOWLISTHEAD'] = "화이트리스트 규칙이 추가되었습니다.";
