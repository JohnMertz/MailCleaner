...
$txt['NOTNEWSALLOWHEAD'] = "Nem a lista de notícias nem a regra da lista de permissões não foram adicionadas.";
$txt['ALLOWNOTNEWSBODY'] = "Uma regra de lista de permissões foi adicionada, no entanto, houve um problema ao adicionar a regra de lista de permissões de boletim informativo.";
$txt['ALLOWNOTNEWSHEAD'] = "Allowlist foi adicionado, mas a lista de notícias não.";
$txt['NEWSNOTALLOWBODY'] = "Uma regra de boletim informativo foi adicionada, no entanto, houve um problema ao adicionar a regra de lista de permissões.";
$txt['NEWSNOTALLOWHEAD'] = "A lista de notícias foi adicionada, mas a lista de permissões não.";
$txt['NEWSALLOWLISTBODY'] = "Uma lista de notícias e regra de lista de permissões foram adicionadas. As mensagens futuras deste remetente não serão sinalizadas se forem detectadas como um boletim informativo ou spam.";
$txt['NEWSALLOWLISTHEAD'] = "Regras de lista de notícias e lista de permissão foram adicionadas.";
$txt['ADDALLOWNEWSLIST'] = "Colocar na lista de permissões todos os spams futuros do mesmo remetente? Aceita também newsletters deste remetente?";
/*
 * Newslist and Allowlist rule
 */
$txt['ADDNEWSALLOWLIST'] = "Aceitar todas as futuras newsletters do mesmo remetente? Também colocar na lista de permissões todas as mensagens de spam desse remetente?";
...
$txt['ALLOWLISTBODY'] = "Uma regra de lista de permissões foi adicionada. As mensagens futuras deste remetente não serão sinalizadas se forem detectadas como spam.";
