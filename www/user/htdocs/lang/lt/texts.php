...
$txt['NOTALLOWLISTBODY'] = "Kilo problema įtraukiant baltąjį sąrašą.";
...
$txt['NOTNEWSALLOWBODY'] = "Kilo problema pridedant šias taisykles.";
$txt['NOTNEWSALLOWHEAD'] = "Nei naujienų sąrašo, nei baltojo sąrašo taisyklė nepridėta.";
$txt['ALLOWNOTNEWSBODY'] = "Pridėta baltojo sąrašo taisyklė, tačiau kilo problemų pridedant naujienlaiškio baltojo sąrašo taisyklę.";
$txt['ALLOWNOTNEWSHEAD'] = "Baltasis sąrašas buvo pridėtas, bet naujienų sąrašas ne.";
$txt['NEWSNOTALLOWBODY'] = "Buvo pridėta naujienlaiškio taisyklė, tačiau iškilo problema pridedant baltojo sąrašo taisyklę.";
$txt['NEWSNOTALLOWHEAD'] = "Naujienų sąrašas buvo pridėtas, bet baltasis sąrašas ne.";
$txt['NEWSALLOWLISTBODY'] = "Pridėta naujienų sąrašo ir baltojo sąrašo taisyklė. Būsimi šio siuntėjo pranešimai nebus žymimi, jei bus aptikti kaip naujienlaiškiai arba nepageidaujami laiškai.";
$txt['NEWSALLOWLISTHEAD'] = "Pridėtos naujienų sąrašo ir baltojo sąrašo taisyklės.";
$txt['ADDALLOWNEWSLIST'] = "Į baltąjį sąrašą įtraukti visas būsimas to paties siuntėjo siunčiamas reklamines žinutes? Taip pat priimti visus šio siuntėjo naujienlaiškius?";
/*
 * Newslist and Allowlist rule
 */
$txt['ADDNEWSALLOWLIST'] = "Priimti visus būsimus to paties siuntėjo naujienlaiškius? Taip pat įtraukti į baltąjį sąrašą visus šio siuntėjo nepageidaujamus pranešimus?";
$txt['NOTALLOWLISTHEAD'] = "Baltojo sąrašo taisyklė nebuvo pridėta.";
$txt['ALLOWLISTBODY'] = "Pridėta baltojo sąrašo taisyklė. Būsimi šio siuntėjo pranešimai nebus žymimi, jei bus aptikti kaip nepageidaujami.";
$txt['ALLOWLISTHEAD'] = "Baltojo sąrašo taisyklė pridėta.";
/*
 * Allowlist rule
 */
$txt['ADDALLOWLIST'] = "Į baltąjį sąrašą įtraukti visas būsimas to paties siuntėjo siunčiamas reklamines žinutes?";
