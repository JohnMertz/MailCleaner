...
//old
$txt['ALLOWLISTFOR'] = "__PARAM__ 白名单";
//old
...
$txt['ALLOWLISTSHORTHELP'] = "此白名单包含隔离保留永不适用的受信任发件人地址。<br />
                                   警告:此功能应作为临时解决方案使用，因为它降低了整体保护。
...
";
$txt['ALLOWLISTFORADDRESS'] = "地址白名单";
$txt['ADDAALLOWENTRY'] = "向列表中添加地址";
$txt['ALLOWLISTENTRYTOADD'] = "输入要添加到白名单中的地址。您还可以添加可选注释。";
$txt['REMOVEAALLOWENTRYSHORTHELP'] = "从列表中选择要修改的地址或地址, 然后单击所需的操作按钮。";
