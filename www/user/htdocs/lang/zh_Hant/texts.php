...
//old
$txt['ALLOWLISTFOR'] = "__PARAM__ 白名單";
//old
...
$txt['ALLOWLISTSHORTHELP'] = "白名單中包含的受信任寄件者位址將不會發生任何隔離保留. <br/> 警告: 此功能應作為臨時解決方案使用, 因為它降低了整體保護。
...
";
$txt['ALLOWLISTFORADDRESS'] = "位址的白色清單";
$txt['ADDAALLOWENTRY'] = "向清單中添加位址";
$txt['ALLOWLISTENTRYTOADD'] = "輸入要添加到白色清單中的位址。您還可以添加可選注釋。";
$txt['REMOVEAALLOWENTRYSHORTHELP'] = "選擇要從清單中修改的位址或位址, 然後按一下所需的操作按鈕。";
...
$txt['NOTNEWSALLOWBODY'] = "加入這些規則發生問題。";
$txt['NOTNEWSALLOWHEAD'] = "不管電子報列表或是白名單都尚未加入。";
$txt['ALLOWNOTNEWSBODY'] = "已將規則加入白名單，不過加入電子報白名單發生問題。";
$txt['ALLOWNOTNEWSHEAD'] = "已加入白名單但是尚未加入電子報列表。";
$txt['NEWSNOTALLOWBODY'] = "電子報規則已加入，但是加入白名單發生問題。";
$txt['NEWSNOTALLOWHEAD'] = "已將規則加入電子報列表，但是尚未加入白名單。";
$txt['NEWSALLOWLISTBODY'] = "已將規則加入至電子報列表及白名單。將來從此寄件者的信件不會被標記為電子報或是垃圾郵件。";
$txt['NEWSALLOWLISTHEAD'] = "已將規則加入至電子報列表及白名單。";
$txt['ADDALLOWNEWSLIST'] = "未來將所有從相同寄件者垃圾郵件列入白名單? 並且將接受此寄件者的電子報?";
/*
 * Newslist and Allowlist rule
 */
$txt['ADDNEWSALLOWLIST'] = "未來將接受所有從相同寄件者的電子報? 並且將此寄件者的垃圾郵件列入到白名單?";
$txt['NOTALLOWLISTBODY'] = "新增至白名單發生問題。";
$txt['NOTALLOWLISTHEAD'] = "尚未將規則加入至白名單。";
$txt['ALLOWLISTBODY'] = "已將規則加入至白名單。將來從此寄件者的信件不會被標記為垃圾郵件。";
$txt['ALLOWLISTHEAD'] = "已將此規則加入至白名單。";
/*
 * Allowlist rule
 */
$txt['ADDALLOWLIST'] = "將所有來自同個寄件者的垃圾郵件列入白名單?";
