...
$replace = array(
        ...
        "__FORM_INPUTENABLEALLOWLIST__" => $gform->checkbox('enable_whitelists', 1, $antispam_->getPref('enable_whitelists'), allowlistWarning(), 1),
        "__FORM_INPUTENABLEWARNLIST__" => $gform->checkbox('enable_warnlists', 1, $antispam_->getPref('enable_warnlists'), '', 1),
	"__FORM_INPUTENABLEBLOCKLIST__" => $gform->checkbox('enable_blacklists', 1, $antispam_->getPref('enable_blacklists'), '', 1),
        ...
        "__LINK_EDITALLOWLIST__" => "wwlist.php?t=1&a=0",
