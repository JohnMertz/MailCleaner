...
if ($antispam_->getPref('enable_whitelists') && !$domain->getPref('enable_whitelists')) {
  $template->setCondition('SEEALLOWLISTENABLER', true);
...
if ($antispam_->getPref('enable_whitelists') && ( $domain->getPref('enable_whitelists') || $selected_address->getPref('has_whitelist'))) {
  $template->setCondition('SEEALLOWLISTEDIT', true);
  $template->setCondition('SEELISTS', true);
}
...
$replace = array(
        ...
        "__FORM_INPUTENABLEALLOW__" => $eform->checkbox('has_whitelist', 1, $selected_address->getPref('has_whitelist'), allowlistWarning(), 1),
        "__FORM_INPUTENABLEWARN__" => $eform->checkbox('has_warnlist', 1, $selected_address->getPref('has_warnlist'), '', 1),
	"__FORM_INPUTENABLEBLOCK__" => $eform->checkbox('has_blacklist', 1, $selected_address->getPref('has_blacklist'), '', 1),
        ...
        "__LINK_EDITALLOWLIST__" => "wwlist.php?t=1&a=".$selected_address->getPref('address'),
