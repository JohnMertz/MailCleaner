...
$help['ALLOWWARNLIST'] =
"<h1>Allowlists and warnlists</h1>
<b>Allowlists</b> let users set up a list of sender that will never be flagged as spam or put in quarantine. 
...
<br>With many entries in allowlists, your filter may become less efficient and being open to smart spam campains.
<br><br>
...
<br>Now if you really want to enable allowlists for the whole domain, you have been warned !
 ";
...
<h2>Enable allowlists:</h2>This is the main switch to enable/disable allowlists. Allowlisting can be dangerous and may be exploited by spammers. Use this option with caution.
<h2>Enable blocklists:</h2>This is the main switch to enable/disable blocklists. 
<h2>Enable warnlists:</h2>This is the main switch to enable/disable warnlists. Warnlists are less dangerous than allowlists. Using it before enabling allowlists is generally a good idea.
